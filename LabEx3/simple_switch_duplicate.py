...
Authors of base adaption for packet duplication
...
import ryu.lib.ofctl_v1_0 as ofctl
...
class SimpleSwitch(app_manager.RyuApp):
    ...
    def add_flow(self, datapath, in_port, dl_dst, actions):
        ofproto = datapath.ofproto

        match = datapath.ofproto_parser.OFPMatch(
            in_port=in_port, dl_type=0x0800, nw_proto=1, dl_dst=haddr_to_bin(dl_dst))
    ...
    def _packet_in_handler(self, ev):
        ...
        self.logger.info("out_port in %s ", out_port)
